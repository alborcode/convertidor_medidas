/*
Clase Pantalla de conversiones de Areas
*/
...
import 'package:convertidor_medidas/ui/utils/utils.dart';
  ...
  class ConversionArea extends StatefulWidget {
  const ConversionArea({Key? key}) : super(key: key);

  @override
  ConversionAreaState createState() => ConversionAreaState();
  }

  class ConversionAreaState extends State<ConversionArea> {
  ...
  void initState() {
    ...
    this.deMedida = Area.medidasArea[this.valorInicial];
    // Cargo el valor aMedida
    this.aMedida = Area.medidasArea[this.valorFinal];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Conversión de Areas"),
            ...
            child: Column(
              children: [
                ...
                DropdownButton<String>(
                    isExpanded: true,
                    value: deMedida,
                    items: Area.medidasArea.map((elemento) {
                    ...
                    onChanged: (value) {
                      setState(() {
                        deMedida = value!;
                        valorInicial = Area.medidasArea.indexOf(deMedida);
                      });
                    }),
                SizedBox(
                  height: 8,
                ...
                DropdownButton<String>(
                    ...
                    onChanged: (value) {
                      setState(() {
                        ...
                        aMedida = value!;
                        valorFinal = Area.medidasArea.indexOf(aMedida);
                      });
                    }),
                SizedBox(
                  height: 8,
                      ...
                      child: BotonIconoAnimado(
                        accion: () {
                          ...
                          try {
                            ...
                            setState(() {
                              // aplicamos los calculos
                              this.valorResultado = "${value * Area.factorConversionArea[valorInicial][valorFinal]}";
                            });
                            // ocultar teclado
                            FocusScope.of(context).requestFocus(FocusNode());
                          } catch (e) {
